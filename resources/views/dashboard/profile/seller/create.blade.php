        ...
        <form class="js-validate" novalidate="novalidate" method="POST" action="  {{ route('seller.store') }} " enctype="multipart/form-data">
            ...
            <div class="row">
                    ...
                    <small style="color:red">{{ $message}}</small>
                                    @enderror</label>
                                        ...
                                        <input type="text" class="form-control" name="sirname"  placeholder="Entrer votre nom"  value=""  >
                                    </div>
                                    <!-- End Form Group -->
                    ...
                    @enderror</label>
                                ...
                                <input type="text" class="form-control" name="firstname"  placeholder="Entrer votre prénom"  value=""
                            ">
                            </div>
                            <!-- End Form Group -->
                        ...
                        <div class="js-form-message form-group">
                            <label class="form-label" for="signinSrPasswordExample2">Entrer votre numéro téléphone <span class="text-danger">*</span>  @error('phonenumber')
                                ...
                                @enderror</label></label>
                                                                    <input type="number" class="form-control" name="phonenumber" id="signinSrPasswordExample2" placeholder="Entrer votre numéro de téléphone"
                                                                >
                        </div>
                        <!-- End Form Group -->
                </div>      
            ...
            <div class="js-form-message form-group">
                <label class="form-label" for="signinSrPasswordExample2">Fréquence d'envoie des produits <span class="text-danger">*</span>  @error('frequence')
                                    ...
                                    <small style="color:red">{{ $message}}</small>
                                    @enderror</label></label>
                                    <input type="text" class="form-control" name="frequence" id="signinSrPasswordExample2" placeholder="Exple : 2 mois ou 1 an " >
            </div>
            <!-- End Form Group -->
<!-- End Form Group -->
            <div class="row">
