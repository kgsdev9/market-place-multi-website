                ...
                <div class="my-8 my-xl-8">
                    <div class="row">
                        ...
                        <div class="col-md-8 ml-xl-auto mr-md-auto mr-xl-0 mb-8 mb-md-0 justify-center">
                            ...
                            <form class="js-validate" novalidate="novalidate" method="POST" action="{{route('buyer.store')}}">
                                @csrf
                                <!-- Form Group -->
...
@enderror</label>
                                    ...
                                    <input type="text" class="form-control" name="sirname"  placeholder="Entrer votre nom" aria-label="Username or nom address" required >
                                </div>
                                <!-- End Form Group -->
            ...
            @enderror</label>
                                                ...
                                                <input type="text" class="form-control" name="firstname"  placeholder="" aria-label="Username or nom address" required
                                               ">
                                            </div>
                                            <!-- End Form Group -->
